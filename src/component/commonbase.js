...
//测试数据
import * as data from '../config/global';
			...
			<Navbar inverse collapseOnSelect id="header">
				...
				{this.state.loginState?(
					...
					<Nav pullRight className="navLogin">
						<Button bsStyle="danger"><Link to="/user/login">登入</Link></Button>
						<Button bsStyle="link"><Link to="/user/register">注册</Link></Button>	
					</Nav>
				)}
				</Navbar.Collapse>
			</Navbar>
...
/**
 * loader 组件
 * @params loading 加载器状态，loadertext 加载显示文本，enableclose 加载器是否允许手动关闭
 */
class Loader extends Component{
	...
	static propTypes = {
		...
		loaderText:React.PropTypes.string.isRequired,
		enableclose:React.PropTypes.bool.isRequired
	};
	handleClick(){
	...
	render(){
		return (
			<div className="loader-body" ref={el=>this.loader=el}>
				{this.props.loading && (				
				<div className="loader">
					<div className="loader-bg dark" onClick={this.handleClick}></div>
					<div className="loader-box">
						<div>
							<div className="loader-content">
								<div className="loader-icon"><i className="fa fa-spinner fa-pulse"></i></div>
								<div className="loader-text">{this.props.loaderText}</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div className="toast-box">
					<div>
						<div className="toast-content">
							<div className="toast-text">{this.props.message}</div>
						</div>
					</div>
				</div>
			</div>
